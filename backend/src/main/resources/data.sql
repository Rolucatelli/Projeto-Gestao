...
INSERT INTO products (name, short_description, full_description, category_id, price, discount, is_active, stock_amount, cost, dimensions) VALUES
('Greatest Hits', 'Compilation album', 'A collection of the best songs from various albums by the artist.', 1, 15.99, 10, true, 100, 10.00, '10x10x1 cm'),
('Live Concert Performance', 'Live album recording', 'A live performance of popular songs from the artist recorded on stage.', 1, 19.99, 15, true, 50, 12.00, '10x10x1 cm'),
('Acoustic Sessions', 'Unplugged album', 'An acoustic version of famous tracks performed in a studio setting.', 1, 12.99, 20, true, 75, 8.00, '10x10x1 cm');

-- Insert products into the 'products' table for the 'Instruments' category
INSERT INTO products (name, short_description, full_description, category_id, price, discount, is_active, stock_amount, cost, dimensions) VALUES
('Electric Guitar', 'String instrument', 'A solid body electric guitar perfect for rock music.', 2, 299.99, 5, true, 30, 150.00, '100x40x10 cm'),
('Acoustic Guitar', 'String instrument', 'A classic acoustic guitar for beginners and professionals alike.', 2, 199.99, 10, true, 50, 120.00, '100x40x10 cm'),
('Drum Set', 'Percussion instrument', 'A full drum set with cymbals, perfect for creating rhythm.', 2, 499.99, 5, true, 20, 350.00, '150x80x50 cm');

-- Insert products into the 'products' table for the 'Vinyl Records' category
INSERT INTO products (name, short_description, full_description, category_id, price, discount, is_active, stock_amount, cost, dimensions) VALUES
('Classic Rock Vinyl', 'Vinyl record', 'A vinyl record featuring classic rock songs.', 3, 25.99, 5, true, 40, 15.00, '12x12x1 cm'),
('Jazz Collection Vinyl', 'Vinyl record', 'A vinyl collection of the best jazz music performances.', 3, 29.99, 10, true, 35, 18.00, '12x12x1 cm'),
('Vinyl Collection: 80s Hits', 'Vinyl record', 'A collection of 80s hits on vinyl.', 3, 22.99, 8, true, 60, 13.00, '12x12x1 cm');

-- Insert products into the 'products' table for the 'Music Accessories' category
INSERT INTO products (name, short_description, full_description, category_id, price, discount, is_active, stock_amount, cost, dimensions) VALUES
('Noise Cancelling Headphones', 'Headphones', 'High-quality headphones with active noise cancellation for an immersive listening experience.', 4, 89.99, 15, true, 100, 50.00, '20x10x5 cm'),
('Portable Bluetooth Speaker', 'Speaker', 'A small portable speaker with Bluetooth connectivity for music on the go.', 4, 49.99, 10, true, 150, 30.00, '15x10x5 cm'),
('Guitar Picks (Set of 10)', 'Accessory', 'A set of 10 durable guitar picks for different playing styles.', 4, 9.99, 0, true, 200, 2.00, '5x5x0.5 cm');

-- Insert products into the 'products' table for the 'Music Equipment' category
INSERT INTO products (name, short_description, full_description, category_id, price, discount, is_active, stock_amount, cost, dimensions) VALUES
('DJ Mixer', 'Music Equipment', 'A professional DJ mixer for mixing tracks at live events.', 5, 299.99, 5, true, 25, 180.00, '30x20x10 cm'),
('Microphone', 'Music Equipment', 'A high-quality microphone for studio and live performances.', 5, 79.99, 10, true, 100, 40.00, '15x5x5 cm'),
('Sound Amplifier', 'Music Equipment', 'A powerful sound amplifier for high-volume performances and studio work.', 5, 199.99, 8, true, 40, 120.00, '40x25x15 cm');
