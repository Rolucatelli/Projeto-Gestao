...
public class UserServiceTest {
    ...
    public void givenInvalidUserEmail_whenFindByEmail_thenThrowException(){
        ...
        //Act
        RuntimeException runtimeException = assertThrows(RuntimeException.class, () -> userService.findUserByEmail("email@email.com"));
    ...
    public void givenPageObject_whenRetrieveAllUsers_thenReturnUserDataVOPage(){
        ...
        when(userRepositoryMock.findAll(any(Pageable.class))).thenReturn(usersPage);

        //Act
        Page<UserDataVO> response = userService.retrieveAllUsers(PageRequest.of(0, 2));
